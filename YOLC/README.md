...
[![Paper](https://img.shields.io/badge/Paper-IEEE%20T--ITS%202024-blue.svg)](https://ieeexplore.ieee.org/document/10530324)
...
<p align="center">
  <img src="framework.jpg" alt="YOLC Architecture Framework" width="90%"/>
</p>
...
In YOLC (`models/losses/gwd_loss.py`), the distance is transformed into a continuous loss function:
...
Download the **VisDrone2019-DET** dataset and set up the directory structure under `data/VisDrone2019/`:
...
- Place the downloaded checkpoint file into `./work_dirs/yolc/epoch_xx.pth` or update the path in `eval_yolc.py`.
